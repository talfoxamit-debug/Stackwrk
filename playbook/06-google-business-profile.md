...
designer Fort Lauderdale."** It's free, it's the #1 local-SEO asset, and it
doubles as social proof. Here's the exact setup for Stackwrk.

> I can't create it for you (it needs your Google login + a verification only you
> can complete), but follow this and you'll have it done right in ~20 minutes,
> plus a few days for verification.

## 1. Start it
1. Go to **business.google.com** → **Manage now**.
2. Sign in with the Google account you want to *own* this forever. Use a Google
...
> Lauderdale, Broward, Miami-Dade and all of South Florida. Free mockup at
> stackwrk.com.

**Services** (add each with a short description + "from $X"):
...
## 8. Reviews = the #1 ranking factor
- The profiles at the top have the most (real) reviews. As you close your first
  fence clients, send each a review request the day the site goes live.
- Once your profile is verified, tell me and **I'll generate your direct
  "leave a review" link** and add a review CTA to stackwrk.com.

## 9. Stay active (5 min/week)
- Post a **Google Post** weekly (a new project, an offer, a quick tip). Active
  profiles rank better and it's free reach.
