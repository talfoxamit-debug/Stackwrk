...
## TOMORROW (your first day: ~3 focused hours)

**Block 1, Setup (45 min)**
- [ ] Buy `getstackwrk.com`, sign up for Instantly, start domain **warmup** (this is the long pole, do it first, it just runs in the background for 2 weeks).
- [ ] Open **stackwrk.com/prospects** → click **Load starter list (254)** → bookmark it.
- [ ] Apply for your **EIN** (10 min, free) so Stripe is ready this week.
...
## The money math (base case ≈ 2 clients/mo after ramp)
- Avg build ~$3,500 + care plan ~$175/mo, ~85% attach.
- **Month 3:** ~6 clients → ~$21k billed + ~$1k/mo recurring.
- **Month 6:** ~$42k cumulative + ~$2k/mo recurring.
- **Month 12:** ~$91k in builds + **~$4k/mo recurring (~$48k/yr)** that renews before you make a single call in year 2.
- The lever: **one extra client/month** ≈ +$49k build revenue + ~$2k/mo MRR by month 12. That comes from **list quality + email deliverability**, not working harder.
...
| File | What it is |
|---|---|
| `00-RUNBOOK.md` | This, the master plan + tomorrow |
| `01-email-sequences.md` | Cold email + follow-ups (also in the CRM, auto-filled) |
| `02-call-scripts.md` | Cold-call opener, objections, voicemail, texts |
| `03-service-agreement.md` | The client contract (have an FL attorney glance once) |
| `04-systems.md` | Accounts/tools to open, in order, + how it all connects |
| `../leads-fence-southfl.csv` | Your 254 leads (248 phones, 59 emails, 50 no-site) |
| `stackwrk.com/prospects` | Your live CRM, click "Load starter list" |
| `stackwrk.com/demos/apex-fence` | The demo you personalize per prospect |

## Reality checks (so you don't stall)
- **Phone-first.** 248 phones vs 59 emails, and your best leads (no site) have *no* email. Calling is the fastest path to your first deal. The email machine is the *scalable* second engine once the domain warms up.
- **Founder pricing is a tool, not a discount.** $1,500 buys you proof. Charge full price by client #4.
- **The list is a starting point,** not sacred, refresh it from Outscraper monthly, and always confirm the owner's name before you call (Google the business).
- **Legal:** manual dials only, real opt-out on emails, attorney-check the contract once. You're fine, just don't autodial cells or blast cold SMS.
