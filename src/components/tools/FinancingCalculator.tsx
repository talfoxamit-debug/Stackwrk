  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
      <div>
        ...
        <p className="mt-3 text-[0.7rem] text-slate-400">Illustrative at {apr}% APR, $0 down. Your actual rate/term depend on approval — checking won&rsquo;t affect your credit.</p>
      </div>
